...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Plottingid Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/luzofex/plottingid-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
echo ""
echo "Plottingid blockchain install.sh complete."
echo "For assistance join us on Discord in the #testnet chat channel:"
echo "https://discord.gg/TgJyxsEFFc"
echo ""
echo "Try the Quick Start Guide to running plottingid-blockchain:"
echo "https://github.com/luzofex/plottingid-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'plottingid init' to begin."
