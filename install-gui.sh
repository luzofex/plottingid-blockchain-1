...
if [ -z "$VIRTUAL_ENV" ]; then
  echo "This requires the plottingid python virtual environment."
...
# Allows overriding the branch or commit to build in plottingid-blockchain-gui
SUBMODULE_BRANCH=$1
...
echo ""
echo "Plottingid blockchain install-gui.sh completed."
echo ""
echo "Type 'cd plottingid-blockchain-gui' and then 'npm run electron &' to start the GUI."
