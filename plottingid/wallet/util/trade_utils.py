...
from plottingid.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "plottingid" in cc_discrepancies:
                    cc_discrepancies["plottingid"] = cc_discrepancies["plottingid"] + diff
                else:
                    cc_discrepancies["plottingid"] = diff
