...
from plottingid.server.ssl_context import plottingid_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"plottingid_{service_name}"
        ...
        plottingid_ca_crt, plottingid_ca_key = plottingid_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = PlottingidServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (plottingid_ca_crt, plottingid_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for PlottingidServer to be closed")
