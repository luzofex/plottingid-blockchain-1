...
from plottingid.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from plottingid.harvester.harvester import Harvester
from plottingid.plotting.plot_tools import PlotInfo, parse_plot_info
from plottingid.protocols import harvester_protocol
from plottingid.protocols.farmer_protocol import FarmingInfo
from plottingid.protocols.protocol_message_types import ProtocolMessageTypes
from plottingid.server.outbound_message import make_msg
...
from plottingid.util.api_decorators import api_request, peer_required
from plottingid.util.ints import uint8, uint32, uint64
from plottingid.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSPlottingidConnection
    ):
        """
