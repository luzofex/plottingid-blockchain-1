...
from plottingid.server.ssl_context import private_ssl_ca_paths
...
class RpcClient:
    """
    Client to Plottingid RPC, connects to a local service. Uses HTTP/JSON, and converts back from
