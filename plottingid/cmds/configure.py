...
from plottingid.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "beta1_introducer.chiaplottingid.com"
            testnet = "testnet7"
            ...
            mainnet_port = "6888"
            mainnet_introducer = "introducer.chiaplottingid.com"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running plottingid services for changes to take effect")
