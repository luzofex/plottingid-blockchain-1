...
from plottingid.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "plottingid/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "plottingid/wallet/puzzles/cc.clvm",
        "plottingid/wallet/puzzles/plottingidlisp_deserialisation.clvm",
        "plottingid/wallet/puzzles/rom_bootstrap_generator.clvm",
        "plottingid/wallet/puzzles/generator_for_single_coin.clvm",
        "plottingid/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "plottingid/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "plottingid/wallet/puzzles/lock.inner.puzzle.clvm",
        "plottingid/wallet/puzzles/p2_conditions.clvm",
        "plottingid/wallet/puzzles/p2_delegated_conditions.clvm",
        "plottingid/wallet/puzzles/p2_delegated_puzzle.clvm",
        "plottingid/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "plottingid/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "plottingid/wallet/puzzles/p2_puzzle_hash.clvm",
        "plottingid/wallet/puzzles/rl_aggregation.clvm",
        "plottingid/wallet/puzzles/rl.clvm",
        "plottingid/wallet/puzzles/sha256tree_module.clvm",
        "plottingid/wallet/puzzles/singleton_top_layer.clvm",
        "plottingid/wallet/puzzles/did_innerpuz.clvm",
        "plottingid/wallet/puzzles/decompress_puzzle.clvm",
        "plottingid/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "plottingid/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "plottingid/wallet/puzzles/block_program_zero.clvm",
        "plottingid/wallet/puzzles/test_generator_deserialize.clvm",
        "plottingid/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["plottingid/wallet/puzzles/create-lock-puzzlehash.clvm", "plottingid/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "plottingid/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to plottingid/wallet/puzzles, but not added to `wallet_program_files`
        """
