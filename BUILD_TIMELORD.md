...
required to run a [Timelord](https://github.com/luzofex/plottigid-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/luzofex/plottingid-blockchain/blob/main/install-timelord.sh)
